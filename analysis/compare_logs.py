...
# path_compare = "E:/px4_data/flight_logs/log_43_2022-6-14-13-40-30"
...
set_point_position["error"] = set_point_position["x"] - local_position["x"]
...
ax.set_ylabel("Position X")
# ax.set_xlim([limL,limR])
l1, = ax.plot(set_point_position["timestamp"],set_point_position["error"],color='orange',label="error")
